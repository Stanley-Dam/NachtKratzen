...
class PlayerSeesSeekerBuilder : PacketBuilder {
    ...
    public PlayerSeesSeekerBuilder(SocketIO.SocketIOComponent socket, NetworkManager networkManager, bool isSeekerVisible) : 
